...
jupiter = body.Body('Jupiter', 266.24, 1589000, 0.8, 0, np.sqrt((.1*10)/0.8),0.8, 'orange')
solar_system.addPlanet(jupiter)

venus = body.Body('Venus', 22.539, 4075, 0.2169,0, 2.124,.45, 'brown')
solar_system.addPlanet(venus)

saturn = body.Body('Saturn', 224.4375, 476000, 1.5, 0, np.sqrt((.1*10)/1.5),0.7, 'yellow')
solar_system.addPlanet(saturn)

uranus = body.Body('Uranus', 97.375, 72500,2.5,0,np.sqrt((.1*10)/2.5),0.6,'blue')
solar_system.addPlanet(uranus)

neptune = body.Body('Neptune', 92.15,85500,3,0,np.sqrt((.1*10)/3),0.55,'purple')
